...
from app_1.database import Base
import uuid
import enum
...
class LessonProgress(Base):
    ...
    status = Column(Enum(LessonProgressStatus, schema='events'), nullable=False, server_default=text("'unlocked'::events.lesson_progress_status"), comment="课程状态")
